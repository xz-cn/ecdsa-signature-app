(() => {
  ...
  var require_package = __commonJS({
    "node_modules/elliptic/package.json"(exports, module) {
      module.exports = {
        ...
        _resolved: "https://registry.npmjs.org/elliptic/-/elliptic-6.6.1.tgz",
        _shasum: "3b8ffb02670bf69e382c7f65bf524c97c5405c06",
        _spec: "elliptic@^6.5.0",
        _where: "/Users/xzhang/CascadeProjects/ecdsa_signature_app",
        author: {
          name: "Fedor Indutny",
  ...
  var require_utils = __commonJS({
    "node_modules/minimalistic-crypto-utils/lib/utils.js"(exports) {
      ...
      utils3.toHex = toHex;
      utils3.encode = function encode(arr, enc) {
        if (enc === "hex")
          return toHex(arr);
        else
          return arr;
  ...
  var require_short = __commonJS({
    "node_modules/elliptic/lib/elliptic/curve/short.js"(exports, module) {
      ...
      Point3.prototype.add = function add2(p) {
        if (this.inf)
          return p;
        if (p.inf)
          return this;
  ...
  var require_mont = __commonJS({
    "node_modules/elliptic/lib/elliptic/curve/mont.js"(exports, module) {
      ...
      Point3.prototype.precompute = function precompute2() {
      };
      ...
      BlockHash.prototype.update = function update(msg, enc) {
        ...
        if (this.pending.length >= this._delta8) {
          ...
          if (this.pending.length === 0)
            this.pending = null;
          msg = utils3.join32(msg, 0, msg.length - r, this.endian);
  ...
  var require__2 = __commonJS({
    "node_modules/hash.js/lib/hash/sha/256.js"(exports, module) {
      ...
      utils3.inherits(SHA2562, BlockHash);
  ...
  var require__3 = __commonJS({
    "node_modules/hash.js/lib/hash/sha/224.js"(exports, module) {
      ...
      utils3.inherits(SHA224, SHA2562);
  ...
  var require__4 = __commonJS({
    "node_modules/hash.js/lib/hash/sha/512.js"(exports, module) {
      ...
      utils3.inherits(SHA5122, BlockHash);
  ...
  var require__5 = __commonJS({
    "node_modules/hash.js/lib/hash/sha/384.js"(exports, module) {
      ...
      utils3.inherits(SHA384, SHA5122);
  ...
  var require_hmac_drbg = __commonJS({
    "node_modules/hmac-drbg/lib/hmac-drbg.js"(exports, module) {
      ...
      HmacDRBG.prototype.reseed = function reseed(entropy, entropyEnc, add2, addEnc) {
        ...
        add2 = utils3.toArray(add2, addEnc);
        assert(
          entropy.length >= this.minEntropy / 8,
          "Not enough entropy. Minimum is: " + this.minEntropy + " bits"
        );
      ...
      HmacDRBG.prototype.generate = function generate(len, enc, add2, addEnc) {
        ...
        if (add2) {
          add2 = utils3.toArray(add2, addEnc || "hex");
          this._update(add2);
        }
        var temp = [];
  ...
  var require_key = __commonJS({
    "node_modules/elliptic/lib/elliptic/ec/key.js"(exports, module) {
      ...
      KeyPair.prototype.verify = function verify3(msg, signature, options) {
    ...
    "node_modules/elliptic/lib/elliptic/ec/index.js"(exports, module) {
      ...
      EC2.prototype._truncateToN = function _truncateToN(msg, truncOnly, bitLength) {
        ...
        if (BN.isBN(msg) || typeof msg === "number") {
          ...
          var str2 = msg.toString();
          byteLength = str2.length + 1 >>> 1;
          msg = new BN(str2, 16);
        }
      ...
      EC2.prototype.verify = function verify3(msg, signature, key, enc, options) {
        if (!options)
          options = {};
        msg = this._truncateToN(msg, false, options.msgBitLength);
  ...
  var USE_ENDOMORPHISM = CURVE2.a === _0n;
  ...
  JacobianPoint.BASE = new JacobianPoint(CURVE2.Gx, CURVE2.Gy, _1n);
  ...
  var Point2 = class _Point {
    ...
    multiplyAndAddUnsafe(Q, a, b) {
      ...
      const aP = a === _0n || a === _1n || this !== _Point.BASE ? P2.multiplyUnsafe(a) : P2.multiply(a);
  ...
  var Signature = class _Signature {
    ...
    static fromCompact(hex) {
      ...
      const str2 = arr ? bytesToHex(hex) : hex;
      if (str2.length !== 128)
        throw new Error(`${name}: Expected 64-byte hex`);
      return new _Signature(hexToNumber(str2.slice(0, 64)), hexToNumber(str2.slice(64, 128)));
    }
    static fromDER(hex) {
      const arr = hex instanceof Uint8Array;
      if (typeof hex !== "string" && !arr)
  ...
  function invertBatch(nums, p = CURVE2.P) {
  ...
  function isWithinCurveOrder(num) {
    return _0n < num && num < CURVE2.n;
  }
  function isValidFieldElement(num) {
    return _0n < num && num < CURVE2.P;
  }
  ...
  function verify2(signature, msgHash, publicKey, opts = vopts) {
    ...
    const R = Point2.BASE.multiplyAndAddUnsafe(P2, u1, u2);
    if (!R)
      return false;
    const v = mod2(R.x, n);
    return v === r;
  ...
  function schnorrChallengeFinalize(ch) {
    return mod2(bytesToNumber(ch), CURVE2.n);
  }
  ...
  var InternalSchnorrSignature = class {
    constructor(message, privateKey, auxRand = utils2.randomBytes()) {
      if (message == null)
    ...
    getScalar(priv) {
      ...
      const scalar = point.hasEvenY() ? priv : CURVE2.n - priv;
    ...
    finalizeNonce(k0h) {
      const k0 = mod2(bytesToNumber(k0h), CURVE2.n);
      if (k0 === _0n)
    ...
    finalizeSig(R, k, e, d) {
      return new SchnorrSignature(R.x, mod2(k + e * d, CURVE2.n)).toRawBytes();
    }
    error() {
    ...
    calcSync() {
      const { m, d, px, rand } = this;
      const tag = utils2.taggedHashSync;
  ...
  function finalizeSchnorrVerify(r, P2, s, e) {
    const R = Point2.BASE.multiplyAndAddUnsafe(P2, normalizePrivateKey(s), mod2(-e, CURVE2.n));
  ...
  async function schnorrVerify(signature, message, publicKey) {
    try {
      const { r, s, m, P: P2 } = initSchnorrVerify(signature, message, publicKey);
      const e = schnorrChallengeFinalize(await utils2.taggedHash(TAGS.challenge, numTo32b(r), P2.toRawX(), m));
      return finalizeSchnorrVerify(r, P2, s, e);
    } catch (error) {
      return false;
    }
  }
  function schnorrVerifySync(signature, message, publicKey) {
    try {
      const { r, s, m, P: P2 } = initSchnorrVerify(signature, message, publicKey);
      const e = schnorrChallengeFinalize(utils2.taggedHashSync(TAGS.challenge, numTo32b(r), P2.toRawX(), m));
      return finalizeSchnorrVerify(r, P2, s, e);
    } catch (error) {
  ...
  var utils2 = {
    ...
    hashToPrivateKey: (hash) => {
      ...
      const num = mod2(bytesToNumber(hash), CURVE2.n - _1n) + _1n;
      return numTo32b(num);
    },
  ...
  async function generatePrivateKey(scheme) {
    switch (scheme) {
      ...
      case "ed25519": {
        ...
        return bytesToHex2(privateBytes);
      }
      case "schnorr": {
        const privateBytes = utils2.randomPrivateKey();
        return bytesToHex2(privateBytes);
      }
      default:
  ...
  async function generatePublicKey(scheme, privateKey) {
    ...
    switch (scheme) {
      ...
      case "ed25519": {
        const publicKey = await getPublicKey(hexToBytes2(privateKey));
        return bytesToHex2(publicKey);
      }
      case "schnorr": {
        const publicKey = getPublicKey2(hexToBytes2(privateKey), true);
        return bytesToHex2(publicKey);
      }
      default:
        throw new Error("Unsupported signature scheme");
  ...
  async function signMessage(scheme, message, privateKey) {
    ...
    switch (scheme) {
      ...
      case "ed25519": {
        const signature = await sign(messageBytes, hexToBytes2(privateKey));
        return bytesToHex2(signature);
      }
      case "schnorr": {
        const messageHash = sha256(messageBytes);
        const signature = await schnorr.sign(messageHash, hexToBytes2(privateKey));
        return bytesToHex2(signature);
      }
      default:
        throw new Error("Unsupported signature scheme");
  ...
  async function verifySignature(scheme, message, signature, publicKey) {
    try {
      ...
      switch (scheme) {
        ...
        case "ed25519": {
          return await verify(
            hexToBytes2(signature),
            messageBytes,
            hexToBytes2(publicKey)
          );
        }
        case "schnorr": {
          const messageHash = sha256(messageBytes);
          return await schnorr.verify(
            hexToBytes2(signature),
            messageHash,
            hexToBytes2(publicKey.slice(2))
            // Remove '02' or '03' prefix for x-only pubkey
          );
        }
        default:
          throw new Error("Unsupported signature scheme");
  ...
  window.ellipticLib = import_elliptic.default;
  window.nobleEd25519 = ed25519_exports;
  window.nobleSecp256k1 = esm_exports;
  window.cryptoUtils = {
    generatePrivateKey,
    generatePublicKey,
    signMessage,
